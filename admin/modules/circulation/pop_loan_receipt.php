...
<div id="receiptBody">
    <table width="100%">
    <tr>
        <td><img src="http://perpustakaan.yarsi.ac.id/images/logo.png"></td><td><div class="receiptHeader"><?php echo $sysconf['library_name'] ?><br /><?php echo $sysconf['library_subname'] ?></div></td>
        <td>Tanggal:<br /><?php echo date("j M Y", strtotime($_SESSION['receipt_record']['date'])); ?></td>
    </tr>
    </table>
    ...
    <div id="receiptInfo">
        ...
        <table width="100%">
		<tr><td>NPM</td><td colspan="3"><?php echo $_SESSION['receipt_record']['memberID'] ?></td></tr>
		<tr><td>Nama</td><td colspan="3"><?php echo $_SESSION['receipt_record']['memberName'] ?></td></tr>
		...
		echo print_r($_SESSION['receipt_record']);
        ?>
        </table>
        <?php } ?>
